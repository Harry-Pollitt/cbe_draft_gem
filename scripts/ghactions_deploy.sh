...
git config --global user.email "hap39@aber.ac.uk"
git config --global user.name "Harry-Pollitt/cbe_draft_gem" 

if [[ "${GITHUB_EVENT_NAME}" == "pull_request" || "${GITHUB_REPOSITORY}" != "Harry-Pollitt/cbe_draft_gem" ]]; then
...
echo "Your new report will be visible at https://Harry-Pollitt.github.io/cbe_draft_gem in a moment."
